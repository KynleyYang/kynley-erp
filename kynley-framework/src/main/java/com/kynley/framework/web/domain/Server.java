package com.kynley.framework.web.domain;

import java.net.UnknownHostException;
import java.util.LinkedList;
import java.util.List;
import java.util.Properties;
import com.kynley.common.utils.Arith;
import com.kynley.common.utils.ip.IpUtils;
import com.kynley.framework.web.domain.server.Cpu;
import com.kynley.framework.web.domain.server.Jvm;
import com.kynley.framework.web.domain.server.Mem;
import com.kynley.framework.web.domain.server.Sys;
import com.kynley.framework.web.domain.server.SysFile;
