/*
 ...
 Source Schema         : kynley-sv3

 Target Server Type    : MySQL
 Target Server Version : 80031
 File Encoding         : 65001

 Date: 09/05/2025 13:25:10
*/
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, '0', 'kynley毕设', 0, 'kynley', '15888888888', 'kynley@qq.com', '0', '0', 'admin', '2025-05-05 08:59:53', 'admin', '2025-05-05 10:36:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 138 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '操作日志', 9, 'com.kynley.web.controller.monitor.SysOperlogController.clean()', 'DELETE', 1, 'admin', 'kynley毕设', '/monitor/operlog/clean', '127.0.0.1', '内网IP', '', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-05-09 13:24:56', 25);
INSERT INTO `sys_oper_log` VALUES (2, '登录日志', 9, 'com.kynley.web.controller.monitor.SysLogininforController.clean()', 'DELETE', 1, 'admin', 'kynley毕设', '/monitor/logininfor/clean', '127.0.0.1', '内网IP', '', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-05-09 13:24:58', 22);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 100, 'admin', 'kynley', '00', 'kynley@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-05-09 13:21:26', 'admin', '2025-05-05 08:59:53', '', '2025-05-09 13:21:25', '管理员');
